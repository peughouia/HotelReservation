...
urlpatterns = ([
    ...
    path('password/reset/confirm/<uid>/<token>/', PasswordResetConfirmAPIView.as_view(), name='password-reset-confirm'),
    ...
    path('reservations/history/', HistoriqueReservationAPIView.as_view(), name='list-reservation'),
    path('listcategory/', CategoryAPIView.as_view(), name='list-category'),


    path('reservations/getAll/', GetAllReservation.as_view(), name='create-reservation'),
    path('reservations/getDetail/<slug:slug>/', DetailReservationAPIView.as_view(), name='detail-reservation'),

    path('reservations/create/<slug:slug>/', CreateReservationView.as_view(), name='create-reservation'),
    path('reservations/<slug:slug>/cancel/', CancelReservationView.as_view(), name='cancel-reservation'),
    path('reservations/<slug:slug>/confirm/', ConfirmReservationView.as_view(), name='confirm-reservation'),
    path('reservations/<slug:slug>/complete/', CompleteReservationView.as_view(), name='complete-reservation'),

    path('rooms/<slug:slug>/availability/', RoomAvailabilityAPIView.as_view(), name='complete-reservation'),
